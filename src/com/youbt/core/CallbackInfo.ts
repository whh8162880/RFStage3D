...
module rf {
    ...
    export class CallbackInfo<T extends Function> implements IRecyclable {
         ...
         * 获取CallbackInfo的实例
         */
        public static get<T extends Function>(callback: T, thisObj?: any, ...args: any[]): CallbackInfo<Function> {
         ...
         * @param thisObj
         */
        public static addToList<T extends Function>(list: CallbackInfo<Function>[], handle: T, thisObj?: any, ...args: any[]) {
