...
module rf{
    export class WebglTest implements IResizeable{
        ...
        public render():void{
            ...
            let vertexCode:string = "attribute vec3 pos_pos;\nvoid main(void){\ngl_Position = vec4(pos_pos,1.0);\n}"
            let fragmentCode:string = "void main(void){\ngl_FragColor=vec4(1.0,0.8,1.0,1.0);\n}";
            context3D.setVertexBufferAt("pos_pos",v,0,Context3DVertexBufferFormat.FLOAT_3);
