...
function updateReferenceFile(files,option) {
    ...
    if (true || (updatedFileContents !== referenceContents)) {

        // grunt.file.write(referenceFile, updatedFileContents);

        referenceFile = referenceFile.replace(".ts",".js");
        updatedFileContents = updatedFileContents.replace(/.ts/g,".js");
        updatedFileContents = updatedFileContents.replace(/\.\.\/src\//g,"");
        grunt.file.write(referenceFile, updatedFileContents);
