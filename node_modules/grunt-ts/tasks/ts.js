...
var debugjsModule = require("./modules/debugjs");
    ...
    grunt.registerMultiTask('ts', 'Compile TypeScript files', function () {
        ...
        function proceed() {
            ...
            asyncSeries(options.CompilationTasks, function (currentFiles) {
                ...
                //     console.log("  "+pro+":"+options[pro]);
                // }

                var debugjs = options.debugjs;
                if(!!debugjs){
                    debugjs[1] = path.resolve(debugjs[1]);
                }
                // var debugjsFile;
                // var debugjsPath;
                // if (!!debugjs) {
                //     debugjsFile = path.resolve(debugjs);
                //     debugjsPath = path.dirname(debugjsFile);
                // }
                // console.log(options.debugjs[0])

                function isReferenceFile(filename) {
                    return path.resolve(filename) === referenceFile;
                }

                // function isDebugjsFile(filename) {
                //     return path.resolve(filename) === debugjsFile;
                // }
                ...
                function filterFilesTransformAndCompile() {
                    ...
                    if(undefined != debugjs){
                        debugjsModule.updateReferenceFile(filesToCompile,debugjs);
                    }

                    // if(!!debugjsPath){

                    //     var result = timeIt(function () {
                    //         return debugjsModule.updateReferenceFile(filesToCompile.filter(function (f) { return !isDebugjsFile(f); }), generatedFiles, debugjsFile, debugjsPath, (options.newLine || utils.eol));
                    //     });
                    // }
